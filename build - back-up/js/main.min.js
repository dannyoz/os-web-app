...
"":[]},P=[""],Q=i.$viewValue,R=H(b)||[],S=E?g(R):R,T={},U=n(Q),V=!1;for(K={},B=0;u=S.length,u>B;B++)m=B,E&&(m=S[B],"$"===m.charAt(0))||(o=R[m],a=j(F,m,o)||"",(c=O[a])||(c=O[a]=[],P.push(a)),C=U(m,o),V=V||C,I=j(A,m,o),I=s(I)?I:"",N=J?J(b,M):E?S[B]:B,J&&(K[N]=m),c.push({id:N,label:I,selected:C}));for(t||(v||null===Q?O[""].unshift({id:"",label:"",selected:!V}):V||O[""].unshift({id:"?",label:"",selected:!0})),z=0,r=P.length;r>z;z++){for(a=P[z],c=O[a],L.length<=z?(e={element:y.clone().attr("label",a),label:c.label},k=[e],L.push(k),h.append(e.element)):(k=L[z],e=k[0],e.label!=a&&e.element.attr("label",e.label=a)),D=null,B=0,u=c.length;u>B;B++)d=c[B],(l=k[B+1])?(D=l.element,l.label!==d.label&&(q(T,l.label,!1),q(T,d.label,!0),D.text(l.label=d.label),D.prop("label",l.label)),l.id!==d.id&&D.val(l.id=d.id),D[0].selected!==d.selected&&(D.prop("selected",l.selected=d.selected),Tc&&D.prop("selected",l.selected))):(""===d.id&&v?G=v:(G=x.clone()).val(d.id).prop("selected",d.selected).attr("selected",d.selected).prop("label",d.label).text(d.label),k.push(l={element:G,label:d.label,id:d.id,selected:d.selected}),q(T,d.label,!0),D?D.after(G):e.element.append(G),D=G);for(B++;k.length>B;)d=k.pop(),q(T,d.label,!1),d.element.remove();f(T,function(a,b){a>0?p.addOption(b):0>a&&p.removeOption(b)})}for(;L.length>z;)L.pop()[0].element.remove()}var z;if(!(z=u.match(e)))throw Gf("iexp","Expected expression in form of '_select_ (as _label_)? for (_key_,)?_value_ in _collection_' but got '{0}'. Element: {1}",u,S(h));var A=d(z[2]||z[1]),B=z[4]||z[6],C=/ as /.test(z[0])&&z[1],D=C?d(C):null,E=z[5],F=d(z[3]||""),G=d(z[2]?z[1]:B),H=d(z[7]),I=z[8],J=I?d(z[8]):null,K={},L=[[{element:h,label:""}]],M={};v&&(a(v)(b),v.removeClass("ng-scope"),v.remove()),h.empty(),h.on("change",k),i.$render=r,b.$watchCollection(H,o),b.$watchCollection(m,o),t&&b.$watchCollection(function(){return i.$modelValue},o)}if(k[1]){for(var o,p=k[0],q=k[1],t=j.multiple,u=j.ngOptions,v=!1,w=!1,x=Uc(b.createElement("option")),y=Uc(b.createElement("optgroup")),z=x.clone(),A=0,B=i.children(),C=B.length;C>A;A++)if(""===B[A].value){o=v=B.eq(A);break}p.init(q,v,z),t&&(q.$isEmpty=function(a){return!a||0===a.length}),u?n(h,i,q):t?m(h,i,q):l(h,i,q,p)}}}}],Jf=["$interpolate",function(a){var b={addOption:o,removeOption:o};return{restrict:"E",priority:100,compile:function(c,d){if(r(d.value)){var e=a(c.text(),!0);e||d.$set("value",c.text())}return function(a,c,d){var f="$selectController",g=c.parent(),h=g.data(f)||g.parent().data(f);h&&h.databound||(h=b),e?a.$watch(e,function(a,b){d.$set("value",a),b!==a&&h.removeOption(b),h.addOption(a,c)}):h.addOption(d.value,c),c.on("$destroy",function(){h.removeOption(d.value)})}}}}],Kf=q({restrict:"E",terminal:!1});return a.angular.bootstrap?void console.log("WARNING: Tried to load angular more than once."):(ca(),ma(ad),void Uc(b).ready(function(){Z(b,$)}))}(window,document),!window.angular.$$csp()&&window.angular.element(document).find("head").prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}</style>'),function(a,b,c){"use strict";function d(){function a(a,c){return b.extend(Object.create(a),c)}function c(a,b){var c=b.caseInsensitiveMatch,d={originalPath:a,regexp:a},e=d.keys=[];return a=a.replace(/([().])/g,"\\$1").replace(/(\/)?:(\w+)([\?\*])?/g,function(a,b,c,d){var f="?"===d?d:null,g="*"===d?d:null;return e.push({name:c,optional:!!f}),b=b||"",""+(f?"":b)+"(?:"+(f?b:"")+(g&&"(.+?)"||"([^/]+)")+(f||"")+")"+(f||"")}).replace(/([\/$\*])/g,"\\$1"),d.regexp=new RegExp("^"+a+"$",c?"i":""),d}var d={};this.when=function(a,e){var f=b.copy(e);if(b.isUndefined(f.reloadOnSearch)&&(f.reloadOnSearch=!0),b.isUndefined(f.caseInsensitiveMatch)&&(f.caseInsensitiveMatch=this.caseInsensitiveMatch),d[a]=b.extend(f,a&&c(a,f)),a){var g="/"==a[a.length-1]?a.substr(0,a.length-1):a+"/";d[g]=b.extend({redirectTo:a},c(g,f))}return this},this.caseInsensitiveMatch=!1,this.otherwise=function(a){return"string"==typeof a&&(a={redirectTo:a}),this.when(null,a),this},this.$get=["$rootScope","$location","$routeParams","$q","$injector","$templateRequest","$sce",function(c,e,f,g,h,j,k){function l(a,b){var c=b.keys,d={};if(!b.regexp)return null;var e=b.regexp.exec(a);if(!e)return null;for(var f=1,g=e.length;g>f;++f){var h=c[f-1],i=e[f];h&&i&&(d[h.name]=i)}return d}function m(a){var d=t.current;q=o(),r=q&&d&&q.$$route===d.$$route&&b.equals(q.pathParams,d.pathParams)&&!q.reloadOnSearch&&!s,r||!d&&!q||c.$broadcast("$routeChangeStart",q,d).defaultPrevented&&a&&a.preventDefault()}function n(){var a=t.current,d=q;r?(a.params=d.params,b.copy(a.params,f),c.$broadcast("$routeUpdate",a)):(d||a)&&(s=!1,t.current=d,d&&d.redirectTo&&(b.isString(d.redirectTo)?e.path(p(d.redirectTo,d.params)).search(d.params).replace():e.url(d.redirectTo(d.pathParams,e.path(),e.search())).replace()),g.when(d).then(function(){if(d){var a,c,e=b.extend({},d.resolve);return b.forEach(e,function(a,c){e[c]=b.isString(a)?h.get(a):h.invoke(a,null,null,c)}),b.isDefined(a=d.template)?b.isFunction(a)&&(a=a(d.params)):b.isDefined(c=d.templateUrl)&&(b.isFunction(c)&&(c=c(d.params)),c=k.getTrustedResourceUrl(c),b.isDefined(c)&&(d.loadedTemplateUrl=c,a=j(c))),b.isDefined(a)&&(e.$template=a),g.all(e)}}).then(function(e){d==t.current&&(d&&(d.locals=e,b.copy(d.params,f)),c.$broadcast("$routeChangeSuccess",d,a))},function(b){d==t.current&&c.$broadcast("$routeChangeError",d,a,b)}))}function o(){var c,f;return b.forEach(d,function(d,g){!f&&(c=l(e.path(),d))&&(f=a(d,{params:b.extend({},e.search(),c),pathParams:c}),f.$$route=d)}),f||d[null]&&a(d[null],{params:{},pathParams:{}})}function p(a,c){var d=[];return b.forEach((a||"").split(":"),function(a,b){if(0===b)d.push(a);else{var e=a.match(/(\w+)(?:[?*])?(.*)/),f=e[1];d.push(c[f]),d.push(e[2]||""),delete c[f]}}),d.join("")}var q,r,s=!1,t={routes:d,reload:function(){s=!0,c.$evalAsync(function(){m(),n()})},updateParams:function(a){if(!this.current||!this.current.$$route)throw i("norout","Tried updating route when with no current route");var c={},d=this;b.forEach(Object.keys(a),function(b){d.current.pathParams[b]||(c[b]=a[b])}),a=b.extend({},this.current.params,a),e.path(p(this.current.$$route.originalPath,a)),e.search(b.extend({},e.search(),c))}};return c.$on("$locationChangeStart",m),c.$on("$locationChangeSuccess",n),t}]}function e(){this.$get=function(){return{}}}function f(a,c,d){return{restrict:"ECA",terminal:!0,priority:400,transclude:"element",link:function(e,f,g,h,i){function j(){n&&(d.cancel(n),n=null),l&&(l.$destroy(),l=null),m&&(n=d.leave(m),n.then(function(){n=null}),m=null)}function k(){var g=a.current&&a.current.locals,h=g&&g.$template;if(b.isDefined(h)){var k=e.$new(),n=a.current,q=i(k,function(a){d.enter(a,null,m||f).then(function(){!b.isDefined(o)||o&&!e.$eval(o)||c()}),j()});m=q,l=n.scope=k,l.$emit("$viewContentLoaded"),l.$eval(p)}else j()}var l,m,n,o=g.autoscroll,p=g.onload||"";e.$on("$routeChangeSuccess",k),k()}}}function g(a,b,c){return{restrict:"ECA",priority:-400,link:function(d,e){var f=c.current,g=f.locals;e.html(g.$template);var h=a(e.contents());if(f.controller){g.$scope=d;var i=b(f.controller,g);f.controllerAs&&(d[f.controllerAs]=i),e.data("$ngControllerController",i),e.children().data("$ngControllerController",i)}h(d)}}}var h=b.module("ngRoute",["ng"]).provider("$route",d),i=b.$$minErr("ngRoute");h.provider("$routeParams",e),h.directive("ngView",f),h.directive("ngView",g),f.$inject=["$route","$anchorScroll","$animate"],g.$inject=["$compile","$controller","$route"]}(window,window.angular),function(a,b,c){"use strict";function d(){this.$get=["$$sanitizeUri",function(a){return function(b){var c=[];return g(b,j(c,function(b,c){return!/^unsafe/.test(a(b,c))})),c.join("")}}]}function e(a){var c=[],d=j(c,b.noop);return d.chars(a),c.join("")}function f(a){var b,c={},d=a.split(",");for(b=0;b<d.length;b++)c[d[b]]=!0;return c}function g(a,c){function d(a,d,f,g){if(d=b.lowercase(d),z[d])for(;t.last()&&A[t.last()];)e("",t.last());y[d]&&t.last()==d&&e("",d),g=v[d]||!!g,g||t.push(d);var i={};f.replace(n,function(a,b,c,d,e){var f=c||d||e||"";i[b]=h(f)}),c.start&&c.start(d,i,g)}function e(a,d){var e,f=0;if(d=b.lowercase(d))for(f=t.length-1;f>=0&&t[f]!=d;f--);if(f>=0){for(e=t.length-1;e>=f;e--)c.end&&c.end(t[e]);t.length=f}}"string"!=typeof a&&(a=null===a||"undefined"==typeof a?"":""+a);var f,g,i,j,t=[],u=a;for(t.last=function(){return t[t.length-1]};a;){if(j="",g=!0,t.last()&&C[t.last()]?(a=a.replace(new RegExp("(.*)<\\s*\\/\\s*"+t.last()+"[^>]*>","i"),function(a,b){return b=b.replace(q,"$1").replace(s,"$1"),c.chars&&c.chars(h(b)),""}),e("",t.last())):(0===a.indexOf("<!--")?(f=a.indexOf("--",4),f>=0&&a.lastIndexOf("-->",f)===f&&(c.comment&&c.comment(a.substring(4,f)),a=a.substring(f+3),g=!1)):r.test(a)?(i=a.match(r),i&&(a=a.replace(i[0],""),g=!1)):p.test(a)?(i=a.match(m),i&&(a=a.substring(i[0].length),i[0].replace(m,e),g=!1)):o.test(a)&&(i=a.match(l),i?(i[4]&&(a=a.substring(i[0].length),i[0].replace(l,d)),g=!1):(j+="<",a=a.substring(1))),g&&(f=a.indexOf("<"),j+=0>f?a:a.substring(0,f),a=0>f?"":a.substring(f),c.chars&&c.chars(h(j)))),a==u)throw k("badparse","The sanitizer was unable to parse the following block of html: {0}",a);u=a}e()}function h(a){if(!a)return"";var b=J.exec(a),c=b[1],d=b[3],e=b[2];return e&&(I.innerHTML=e.replace(/</g,"&lt;"),e="textContent"in I?I.textContent:I.innerText),c+e+d}function i(a){return a.replace(/&/g,"&amp;").replace(t,function(a){var b=a.charCodeAt(0),c=a.charCodeAt(1);return"&#"+(1024*(b-55296)+(c-56320)+65536)+";"}).replace(u,function(a){return"&#"+a.charCodeAt(0)+";"}).replace(/</g,"&lt;").replace(/>/g,"&gt;")}function j(a,c){var d=!1,e=b.bind(a,a.push);return{start:function(a,f,g){a=b.lowercase(a),!d&&C[a]&&(d=a),d||D[a]!==!0||(e("<"),e(a),b.forEach(f,function(d,f){var g=b.lowercase(f),h="img"===a&&"src"===g||"background"===g;H[g]!==!0||E[g]===!0&&!c(d,h)||(e(" "),e(f),e('="'),e(i(d)),e('"'))}),e(g?"/>":">"))},end:function(a){a=b.lowercase(a),d||D[a]!==!0||(e("</"),e(a),e(">")),a==d&&(d=!1)},chars:function(a){d||e(i(a))}}}var k=b.$$minErr("$sanitize"),l=/^<((?:[a-zA-Z])[\w:-]*)((?:\s+[\w:-]+(?:\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)\s*(>?)/,m=/^<\/\s*([\w:-]+)[^>]*>/,n=/([\w:-]+)(?:\s*=\s*(?:(?:"((?:[^"])*)")|(?:'((?:[^'])*)')|([^>\s]+)))?/g,o=/^</,p=/^<\//,q=/<!--(.*?)-->/g,r=/<!DOCTYPE([^>]*?)>/i,s=/<!\[CDATA\[(.*?)]]>/g,t=/[\uD800-\uDBFF][\uDC00-\uDFFF]/g,u=/([^\#-~| |!])/g,v=f("area,br,col,hr,img,wbr"),w=f("colgroup,dd,dt,li,p,tbody,td,tfoot,th,thead,tr"),x=f("rp,rt"),y=b.extend({},x,w),z=b.extend({},w,f("address,article,aside,blockquote,caption,center,del,dir,div,dl,figure,figcaption,footer,h1,h2,h3,h4,h5,h6,header,hgroup,hr,ins,map,menu,nav,ol,pre,script,section,table,ul")),A=b.extend({},x,f("a,abbr,acronym,b,bdi,bdo,big,br,cite,code,del,dfn,em,font,i,img,ins,kbd,label,map,mark,q,ruby,rp,rt,s,samp,small,span,strike,strong,sub,sup,time,tt,u,var")),B=f("animate,animateColor,animateMotion,animateTransform,circle,defs,desc,ellipse,font-face,font-face-name,font-face-src,g,glyph,hkern,image,linearGradient,line,marker,metadata,missing-glyph,mpath,path,polygon,polyline,radialGradient,rect,set,stop,svg,switch,text,title,tspan,use"),C=f("script,style"),D=b.extend({},v,z,A,y,B),E=f("background,cite,href,longdesc,src,usemap,xlink:href"),F=f("abbr,align,alt,axis,bgcolor,border,cellpadding,cellspacing,class,clear,color,cols,colspan,compact,coords,dir,face,headers,height,hreflang,hspace,ismap,lang,language,nohref,nowrap,rel,rev,rows,rowspan,rules,scope,scrolling,shape,size,span,start,summary,target,title,type,valign,value,vspace,width"),G=f("accent-height,accumulate,additive,alphabetic,arabic-form,ascent,attributeName,attributeType,baseProfile,bbox,begin,by,calcMode,cap-height,class,color,color-rendering,content,cx,cy,d,dx,dy,descent,display,dur,end,fill,fill-rule,font-family,font-size,font-stretch,font-style,font-variant,font-weight,from,fx,fy,g1,g2,glyph-name,gradientUnits,hanging,height,horiz-adv-x,horiz-origin-x,ideographic,k,keyPoints,keySplines,keyTimes,lang,marker-end,marker-mid,marker-start,markerHeight,markerUnits,markerWidth,mathematical,max,min,offset,opacity,orient,origin,overline-position,overline-thickness,panose-1,path,pathLength,points,preserveAspectRatio,r,refX,refY,repeatCount,repeatDur,requiredExtensions,requiredFeatures,restart,rotate,rx,ry,slope,stemh,stemv,stop-color,stop-opacity,strikethrough-position,strikethrough-thickness,stroke,stroke-dasharray,stroke-dashoffset,stroke-linecap,stroke-linejoin,stroke-miterlimit,stroke-opacity,stroke-width,systemLanguage,target,text-anchor,to,transform,type,u1,u2,underline-position,underline-thickness,unicode,unicode-range,units-per-em,values,version,viewBox,visibility,width,widths,x,x-height,x1,x2,xlink:actuate,xlink:arcrole,xlink:role,xlink:show,xlink:title,xlink:type,xml:base,xml:lang,xml:space,xmlns,xmlns:xlink,y,y1,y2,zoomAndPan"),H=b.extend({},E,G,F),I=document.createElement("pre"),J=/^(\s*)([\s\S]*?)(\s*)$/;b.module("ngSanitize",[]).provider("$sanitize",d),b.module("ngSanitize").filter("linky",["$sanitize",function(a){var c=/((ftp|https?):\/\/|(mailto:)?[A-Za-z0-9._%+-]+@)\S*[^\s.;,(){}<>"]/,d=/^mailto:/;return function(f,g){function h(a){a&&n.push(e(a))}function i(a,c){n.push("<a "),b.isDefined(g)&&n.push('target="',g,'" '),n.push('href="',a.replace('"',"&quot;"),'">'),h(c),n.push("</a>")}if(!f)return f;for(var j,k,l,m=f,n=[];j=m.match(c);)k=j[0],j[2]==j[3]&&(k="mailto:"+k),l=j.index,h(m.substr(0,l)),i(k,j[0].replace(d,"")),m=m.substring(l+j[0].length);return h(m),a(n.join(""))}}])}(window,window.angular);var dod=angular.module("dod",["ngRoute","ngSanitize"]);dod.config(["$routeProvider","$locationProvider",function(a,b){a.when("/",{templateUrl:"app/views/home/home.html",controller:"home"}).when("/about",{templateUrl:"app/views/about/about.html",controller:"about"}).when("/art",{templateUrl:"app/views/art/art.html",controller:"art"}).when("/art/:artwork",{templateUrl:"app/views/art/single/art-single.html",controller:"artSingle"}).when("/contact",{templateUrl:"app/views/contact/contact.html",controller:"contact"}).when("/websites",{templateUrl:"app/views/websites/websites.html",controller:"websites"}).when("/websites/:website",{templateUrl:"app/views/websites/single/website-single.html",controller:"websiteSingle"}).when("/styleguide",{templateUrl:"app/views/styleguide/styleguide.html"}).otherwise({templateUrl:"app/views/404/404.html",controller:"home"}),b.html5Mode({enabled:!0,requireBase:!1})}]),dod.run(["$rootScope","$http","$timeout","content","api",function(a,b,c,d,e){a.$broadcast("loadingMsg","Loading..."),e.getContent("data").success(function(b){console.log(b),c(function(){d.data=b,d.ready=!0,a.$broadcast("appReady",b)},500)})}]),dod.run(["$templateCache",function(a){"use strict";a.put("app/global/navigation/navigation.html",'<nav class=transition-3 ng-class={show:showNav,open:openNav}><div id=hamburger class=transition-3 ng-click=toggleNav();>menu</div><div id=nav-holder ng-click=hideNav();><ul><li ng-repeat="link in nav" ng-attr-style=transition-delay:{{$index*0.1}}s><a ng-href={{::link.url}} ng-bind=::link.title></a></li></ul></div></nav>'),a.put("app/views/404/404.html",'<div class="page transition-5" ng-class={show:ready,hide:!ready}><section>404 bruv</section></div>'),a.put("app/views/about/about.html",'<div class="page transition-5" ng-class={show:ready,hide:!ready}><header class=grid-row><div class=container><div class=centred><h1 ng-bind=::page.heading></h1><h2 ng-bind=::page.subheading ng-if=page.subheading></h2><p ng-bind-html=::page.intro></p></div></div></header><div class=container><p>Derp</p></div></div>'),a.put("app/views/art/art.html",'<div id=art class="page transition-5" ng-class={show:ready,hide:!ready}><header class=grid-row><div class=container><div class=centred><h1 ng-bind=::page.heading></h1><h2 ng-bind=::page.subheading ng-if=page.subheading></h2><p ng-bind-html=::page.intro></p></div></div></header><div class=container><div class=grid-row ng-if=page.list><div class=art-thumb ng-attr-style=background-image:url({{data.media.thumbnail}}); ng-repeat="(artwork,data) in page.list" ng-click=showWork(artwork)><img class=first src=/img/spacer.png> <img class=second src=/img/spacer.png><div class=overlay><div class=centre><p ng-bind=::data.title></p></div></div></div></div></div></div>'),a.put("app/views/art/single/art-single.html","<div class=centre>{{work.title}}</div>"),a.put("app/views/contact/contact.html",'<div class="page transition-5" ng-class={show:ready,hide:!ready}><header class=grid-row><div class=container><div class=centred><h1 ng-bind=::page.heading></h1><h2 ng-bind=::page.subheading ng-if=page.subheading></h2><p ng-bind-html=::page.intro></p></div></div></header><div class=container><form><fieldset><input name=Name ng-model="message.name"></fieldset><fieldset><input type=email name=Email ng-model="message.email"></fieldset><fieldset><input name=Subject ng-model="message.subject"></fieldset><fieldset><textarea name=Message cols=30 rows=10 ng-model=message.text></textarea></fieldset><fieldset><button ng-click=sendMessage(message);>Send</button></fieldset>{{message}}</form></div></div>'),a.put("app/views/home/home.html",'<div id=home class="page transition-5" dod-perspective=position ng-class={show:ready,hide:!ready}><div class="centre text"><p>X = {{position.xval}}</p><p>Y = {{position.yval}}</p><img src=http://breakupwithie8.com/img/ie8-heart-solo.svg ng-attr-style="transform: rotateX({{position.xval*0.5}}deg) rotateY({{position.yval*0.5}}deg); margin-top:{{position.yval}}px; margin-left:{{position.xval}}px;" width="400"><div class=centre><img src=http://breakupwithie8.com/img/ie8-logo-solo.svg ng-attr-style="transform: rotateX({{position.xval*0.5}}deg) rotateY({{position.yval*0.5}}deg); margin-top:{{position.yval*0.5}}px; margin-left:{{position.xval*0.5}}px" width=180></div><!-- 		<span class="forename">Dan</span>\r\n		<span class="surname">Osborne</span>\r\n		<h1><span>Front end developer</span></h1>\r\n		<h2><span>Digital</span><br/>Designer</h2> --><!-- 		<h3>Artist</h3> --></div></div>'),a.put("app/views/loading/loading.html",'<div class="centre transition-5" ng-class={hide:ready,show:!ready}><p>{{msg}}</p><p>{{percent}}%</p></div>'),a.put("app/views/websites/single/website-single.html","<div class=centre>{{site.title}}</div>"),a.put("app/views/websites/websites.html",'<div id=websites class="page transition-5" ng-class={show:ready,hide:!ready}><header class=grid-row><div class=container><div class=centred><h1 ng-bind=::page.heading></h1><h2 ng-bind=::page.subheading ng-if=page.subheading></h2><p ng-bind-html=::page.intro></p></div></div></header><div class=container><div class="website grid-row" ng-repeat="(website,data) in page.list" ng-click=showSite(website) dod-scroll><div class=website-showcase><div class="tablet transition-3"><div class=front><div class="shine transition-3"></div><img src=http://placehold.it/600x450 alt=""></div><div class="back transition-3"></div></div></div><div class=website-info><h3 ng-bind=::data.title></h3><div ng-bind-html=::data.info></div></div></div></div></div>')}]),dod.directive("dodEvents",["$rootScope",function(a){return{restrict:"A",link:function(b,c,d){var e=angular.element(window),f=0,g={start:{},end:{}};e.on("scroll",function(){a.$broadcast("scrolling")}),e.on("touchstart",function(a){g.start.X=a.touches[0].pageX,g.start.Y=a.touches[0].pageY}),e.on("touchmove",function(a){f++,g.end.X=a.touches[0].pageX,g.end.Y=a.touches[0].pageY}),e.on("touchend",function(a){var b=Math.abs(g.end.X-g.start.X),c=Math.abs(g.end.Y-g.start.Y),d="";d=b>c?g.start.X>g.end.X?"right":"left":g.start.Y>g.end.Y?"down":"up",console.log(f>1?d:"click"),f=0,g={start:{},end:{}}})}}}]),dod.directive("dodPerspective",function(){return{restrict:"A",scope:{position:"=dodPerspective"},link:function(a){var b=angular.element(window);b.bind("mousemove",function(b){var c,d,e=b.pageX,f=b.pageY,g=b.view.outerWidth,h=b.view.outerHeight,i=g/2,j=h/2;c=i>e?"-"+(i-e)/i*100:Math.abs((i-e)/i*100),d=j>f?(j-f)/j*100:"-"+Math.abs((j-f)/j*100),a.$apply(function(){a.position.xval=c,a.position.yval=d})})}}}),dod.directive("dodScroll",["$rootScope",function(a){return{restrict:"A",link:function(b,c,d){function e(){var a=window.innerHeight/1.5,b=c[0].getBoundingClientRect(),d=b.top+b.height,e=b.top,f=e-a;0>f&&d>0?c.removeClass("hidden"):70>d?c.addClass("hidden"):f>0&&c.addClass("hidden")}a.$on("scrolling",function(){e()}),e()}}}]),dod.controller("navigation",["$scope","$timeout","content",function(a,b,c){"use strict";c.ready&&(a.nav=c.data.navigation,a.ready=c.ready),a.showNav=!1,a.openNav=!1,a.$on("appReady",function(b){a.nav=c.data.navigation,a.ready=c.ready}),a.toggleNav=function(){a.showNav?a.hideNav():(a.showNav=!0,a.openNav=!0)},a.hideNav=function(){a.openNav=!1,b(function(){a.showNav=!1},500)}}]),dod.factory("api",["$http",function(a){var b="/api/",c=".json",d=function(d){var e=b+d+c;return a.get(e)},e=function(b){var c="/post-message";return a.post(c,b)};return{getContent:d,postMessage:e}}]),dod.factory("content",function(){return{data:{},ready:!1}}),dod.controller("about",["$scope","content",function(a,b){"use strict";b.ready&&(a.page=b.data.about,a.ready=b.ready),a.$on("appReady",function(c){a.page=b.data.about,a.ready=b.ready})}]),dod.controller("art",["$scope","$location","content",function(a,b,c){"use strict";c.ready&&(a.page=c.data.art,a.images=c.data.images,a.ready=c.ready),a.$on("appReady",function(b){a.page=c.data.art,a.images=c.data.images,a.ready=c.ready}),a.showWork=function(a){b.path("/art/"+a)},a.getThumb=function(b){return a.images[b].path}}]),dod.controller("artSingle",["$scope","$location","content",function(a,b,c){"use strict";var d=location.pathname,e=d.replace("/art/","");c.ready&&(a.work=c.data.art.list[e],a.ready=c.ready,a.work||b.path("/404")),a.$on("appReady",function(d){a.work=c.data.art.list[e],a.ready=c.ready,a.work||b.path("/404")})}]),dod.controller("contact",["$scope","content","api",function(a,b,c){"use strict";b.ready&&(a.page=b.data.contact,a.ready=b.ready),a.$on("appReady",function(c){a.page=b.data.contact,a.ready=b.ready}),a.messageStatus="pending",a.message={name:"Name",subject:"Subject",email:"e-mail",text:"Message"},a.sendMessage=function(b){c.getContent("messages").success(function(b){a.messages=b.messages,a.messages.push(a.message);var d=angular.copy(a.messages);console.log(a.messages),c.postMessage(d).success(function(b){a.messageStatus="sent"}).error(function(b,c,d,e){a.messageStatus="error",console.log("Post error : ",b),console.log("status : ",c),console.log("headers : ",d),console.log("config : ",e)})})}}]),dod.controller("home",["$scope","content",function(a,b){"use strict";b.ready&&(a.page=b.data.home,a.ready=b.ready),a.$on("appReady",function(c){a.page=b.data.home,a.ready=b.ready}),a.position={xval:0,yval:0},a.perspective=function(b,c){var d=a.position.xval;return d}}]),dod.controller("loading",["$scope","content",function(a,b){"use strict";a.msg="Loading...",a.$on("appReady",function(c){a.ready=b.ready,console.log("loaded")}),a.$on("loadingMsg",function(b,c){a.msg=c}),a.$on("remaining",function(b,c){a.percent=100/c.total*c.remaining})}]),dod.controller("websiteSingle",["$scope","$location","content",function(a,b,c){"use strict";var d=location.pathname,e=d.replace("/websites/","");c.ready&&(a.site=c.data.websites.list[e],a.ready=c.ready,a.site||b.path("/404")),a.$on("appReady",function(d){a.site=c.data.websites.list[e],a.ready=c.ready,a.site||b.path("/404")})}]),dod.controller("websites",["$scope","$sce","$location","content",function(a,b,c,d){"use strict";d.ready&&(a.page=d.data.websites,a.ready=d.ready),a.$on("appReady",function(b){a.page=d.data.websites,a.ready=d.ready}),a.showSite=function(a){c.path("/websites/"+a)}}]);